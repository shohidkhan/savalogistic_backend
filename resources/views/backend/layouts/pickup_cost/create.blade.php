            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-body">
                        <h1 class="mb-4">Add a pickup cost</h1>
                        <form action="{{ route('admin.pickup_cost.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="mt-4">
                                ...
                                <a href="{{ route('admin.pickup_cost.index') }}" class="btn btn-danger btn-lg">Back</a>
                            </div>
                        </form>
                    </div>
                </div>
