@extends('backend.app')
@section('title', 'Add Transport Notice')
@section('content')
    <!--begin::Toolbar-->
        ...
        <div class=" container-fluid  d-flex flex-stack flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                ...
                <ul class="breadcrumb fw-semibold fs-base my-1">
                    ...
                    <li class="breadcrumb-item text-muted"> Add transport Notice </li>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-body">
                        <h1 class="mb-4">Add transport notice</h1>
                        <form action="{{ route('admin.transport_notice.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 mt-4">
                                    ...
                                    <input name="code" id="code" class="form-control @error('code') is-invalid @enderror"
                                        placeholder="Enter sub title" value="{{ old('code') }}" >
                                    @error('code')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
