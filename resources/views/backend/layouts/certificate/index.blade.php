                ...
                <div class="col-12">
                    <div class="bg-white p-5">
                        <div class="d-flex justify-content-start mb-5">
                            <a href="{{ route('admin.certificates.create') }}" class="btn btn-primary">Add Certificate
    ...
    @push('script')
        <script type="text/javascript">
            ...
            function statusChange(id) {
                let url = '{{ route('admin.certificates.status', ':id') }}';
                $.ajax({
                    type: "POST",
            ...
            function deleteItem(id) {
                let url = '{{ route('admin.certificates.destroy', ':id') }}';
