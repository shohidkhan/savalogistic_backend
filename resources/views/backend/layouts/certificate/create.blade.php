        ...
        <div class=" container-fluid  d-flex flex-stack flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                ...
                <ul class="breadcrumb fw-semibold fs-base my-1">
                    ...
                    <li class="breadcrumb-item text-muted"> Add Certificate </li>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 mt-4">
                                    ...
                                    <input name="issued_by" id="issued_by" class="form-control @error('issued_by') is-invalid @enderror"
                                        placeholder="Enter issued by" value="{{ old('issued_by') }}">
                                    @error('issued_by')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-lg-4 mt-4 float-right">
                                    <div class="form-check ms-auto" style="margin-top: 35px;">
                                        <input class="form-check-input" type="checkbox" value="1" name="is_verified" id="flexCheckDefault" {{ old('is_verified') ? 'checked' : '' }}>
