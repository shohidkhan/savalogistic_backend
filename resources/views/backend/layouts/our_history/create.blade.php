        ...
        <div class=" container-fluid  d-flex flex-stack flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                ...
                <ul class="breadcrumb fw-semibold fs-base my-1">
                    ...
                    <li class="breadcrumb-item text-muted"> Add History </li>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-body">
                        ...
                        <form action="{{ route('admin.our_history.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 mt-4">
                                    ...
                                    <select name="type" id="type" class="form-control @error('date') is-invalid @enderror">
                                        ...
                                        <option value="Crossing borders">Crossing borders</option>
                                    </select>
                                    @error('type')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
