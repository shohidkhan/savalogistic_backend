                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 mt-4">
                                    ...
                                    <input name="author" id="author" class="form-control @error('author') is-invalid @enderror"
                                        placeholder="Enter author" value="{{ old('author',$data->author) }}">
                                    @error('author')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-lg-12 mt-4">
                                    ...
                                    <textarea name="short_description"  class="form-control @error('short_description') is-invalid @enderror"
                                        placeholder="Enter Short Description" rows="7">{{ old('short_description',$data->short_description) }}</textarea>
                                ...
                                <div class="col-lg-12 mt-4">
                                    ...
                                    <textarea name="long_description" id="long_description" class="form-control @error('long_description') is-invalid @enderror"
                                        placeholder="Enter Short Description" rows="7">{{ old('long_description',$data->long_description) }}</textarea>
