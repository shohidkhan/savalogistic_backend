        ...
        <div class=" container-fluid  d-flex flex-stack flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                ...
                <ul class="breadcrumb fw-semibold fs-base my-1">
                    ...
                    <li class="breadcrumb-item text-muted"> Add Annex Rate </li>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-body">
                        ...
                        <form action="{{ route('admin.annex_rate.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                 ...
                                 <div class="col-lg-6 mt-4">
                                    ...
                                    <select name="segment" id="segment" class="form-control @error('segment') is-invalid @enderror">
                                        <option value="">Select Country</option>
                                        <option value="CH" {{ old('segment') == 'CH' ? 'selected' : '' }}>Switzerland</option>
                                        <option value="FR" {{ old('segment') == 'FR' ? 'selected' : '' }}>French</option>
                                    </select>
                                    @error('segment')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                ...
                                <div class="col-lg-4 mt-4">
                                    ...
                                    <input name="week" id="week" class="form-control @error('week') is-invalid @enderror"
                                        placeholder="Enter week" value="{{ old('week') }}" >
                                    @error('week')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-lg-4 mt-4">
                                    ...
                                    <input name="price_per_km" id="price_per_km" class="form-control @error('price_per_km') is-invalid @enderror"
                                        placeholder="Enter Price Per Km" value="{{ old('price_per_km') }}">
                                    @error('price_per_km')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-lg-4 mt-4">
                                    ...
                                    <input name="margin" id="margin" class="form-control @error('margin') is-invalid @enderror"
                                        placeholder="Enter Margin" value="{{ old('margin') }}">
                                    @error('margin')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
