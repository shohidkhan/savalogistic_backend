        ...
        <div class=" container-fluid  d-flex flex-stack flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                ...
                <ul class="breadcrumb fw-semibold fs-base my-1">
                    ...
                    <li class="breadcrumb-item text-muted"> Edit Social Media </li>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-body">
                        <h1 class="mb-4">Edit  Social Media</h1>
                            ...
                            <div class="row">
                                <div class="col-lg-6 mt-4">
                                    ...
                                    <input name="social_media" id="social_media" class="form-control @error('social_media') is-invalid @enderror"
                                        placeholder="Enter social media name" value="{{ old('social_media',$data->social_media) }}" >
                                    @error('social_media')
                                ...
                                <div class="col-lg-6 mt-4">
                                    ...
                                    <input name="profile_link" id="profile_link" class="form-control @error('profile_link') is-invalid @enderror"
                                        placeholder="Enter profile link" value="{{ old('profile_link',$data->profile_link) }}">
                                    @error('profile_link')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
