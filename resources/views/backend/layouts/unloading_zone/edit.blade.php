            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-body">
                        ...
                        <form action="{{ route('admin.unloading_zone.update',$data->id) }}" method="POST" enctype="multipart/form-data">
                            @method('PUT')
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-lg-4 mt-4">
                                 ...
                                 <div class="col-lg-4 mt-4">
                                    ...
                                    <input name="time" id="time" class="form-control @error('time') is-invalid @enderror"
                                        placeholder="Enter time" value="{{ old('time',$data->time) }}">
                                    @error('time')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="mt-4">
                                ...
                                <a href="{{ route('admin.unloading_zone.index') }}" class="btn btn-danger btn-lg">Back</a>
                            </div>
                        </form>
                    </div>
                </div>
